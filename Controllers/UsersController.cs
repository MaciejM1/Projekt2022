...
namespace Projekt2022.Controllers
{
    public class UsersController : Controller
    {
        private readonly Projekt2022Context _context;

        public UsersController(Projekt2022Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'Projekt2022Context.User'  is null.");
        }
